...
namespace Entitas {
    public partial class Entity {
        public Assets.ParentComponent parent { get { return (Assets.ParentComponent)GetComponent(ComponentIds.Parent); } }

        public bool hasParent { get { return HasComponent(ComponentIds.Parent); } }

        static readonly Stack<Assets.ParentComponent> _parentComponentPool = new Stack<Assets.ParentComponent>();
        ...
        public Entity AddParent(int newId) {
            var component = _parentComponentPool.Count > 0 ? _parentComponentPool.Pop() : new Assets.ParentComponent();
            component.Id = newId;

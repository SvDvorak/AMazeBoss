...
namespace Entitas {
    public partial class Entity {
        public Assets.ThinkDelayComponent thinkDelay { get { return (Assets.ThinkDelayComponent)GetComponent(ComponentIds.ThinkDelay); } }

        public bool hasThinkDelay { get { return HasComponent(ComponentIds.ThinkDelay); } }

        static readonly Stack<Assets.ThinkDelayComponent> _thinkDelayComponentPool = new Stack<Assets.ThinkDelayComponent>();
        ...
        public Entity AddThinkDelay(float newTimeLeft) {
            var component = _thinkDelayComponentPool.Count > 0 ? _thinkDelayComponentPool.Pop() : new Assets.ThinkDelayComponent();
